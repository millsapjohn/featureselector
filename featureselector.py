...
class FeatureSelector:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FeatureSelector_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Feature Selector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FeatureSelector', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/featureselector/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Feature Selector'),
            callback=self.run,
